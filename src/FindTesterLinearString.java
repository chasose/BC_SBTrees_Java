...
public class FindTesterLinearString<Key,TreeType extends Tree<String, Integer>> extends TreeAnalyzer<TreeType,Key> {


    public FindTesterLinearString(TreeType tree, int repNumb, int stepSize, int stepCount, String name) {
