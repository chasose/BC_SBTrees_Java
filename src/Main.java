public class Main {
    public static void main(String[] args) {
        ...
        InsertTesterRNGINT<Integer,ScapeGoatTree<Integer,Integer>> testerRNGINT_sg = new InsertTesterRNGINT<>(sg_tree_,10, 100, 750, "Linear/sg_tree/I-R-SG-INT.csv");
...
*/
        ...
        RemoveTesterLinearINT<Integer,splay_tree<Integer,Integer>> testerLinearINT_splay_treeR = new RemoveTesterLinearINT<>(splay_tree,50, 100, 750, "Linear/splay_tree/R-L-SPLAY-INT.csv");
        testerLinearINT_splay_treeR.analyze();

        RemoveTesterRNGINT<Integer,splay_tree<Integer,Integer>> testerRNGINT_splay_treeR = new RemoveTesterRNGINT<>(splay_tree,50, 100, 750, "RNG/splay_tree/R-R-SPLAY-INT.csv");
        testerRNGINT_splay_treeR.analyze();
        ...
        *//*InsertTesterLinearString<String,splay_tree<String,Integer>> testerLinearString_splay = new InsertTesterLinearString<>(splay_trees,50, 100, 750, "RNG/splay_tree/I-L-SPLAY-String.csv");
        ...
        RemoveTesterLinearString<String,splay_tree<String,Integer>> testerLinearString_splay_treeR = new RemoveTesterLinearString<>(splay_trees,50, 100, 750, "Linear/splay_tree/R-L-SPLAY-String.csv");
