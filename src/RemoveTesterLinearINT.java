...
public class RemoveTesterLinearINT<Key,TreeType extends Tree<Integer, Integer>> extends TreeAnalyzer<TreeType,Key> {


    public RemoveTesterLinearINT(TreeType tree, int repNumb, int stepSize, int stepCount, String name) {
