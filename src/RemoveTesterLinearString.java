...
public class RemoveTesterLinearString<Key,TreeType extends Tree<String, Integer>> extends TreeAnalyzer<TreeType,Key> {


    public RemoveTesterLinearString(TreeType tree, int repNumb, int stepSize, int stepCount, String name) {
