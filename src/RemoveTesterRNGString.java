...
public class RemoveTesterRNGString<Key,TreeType extends Tree<String, Integer>> extends TreeAnalyzer<TreeType,Key> {


    public RemoveTesterRNGString(TreeType tree, int repNumb, int stepSize, int stepCount, String name) {
